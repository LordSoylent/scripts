...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='faust.conf'
CONFIGFOLDER='/root/.faust'
COIN_DAEMON='faustd'
COIN_CLI='faust-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/FaustRepo/FaustRepo.git'
COIN_TGZ='https://github.com/FaustRepo/FaustRepo/releases/download/v1.0.0.1/binaries.tgz'
